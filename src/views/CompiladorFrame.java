...
public class CompiladorFrame extends JFrame implements ActionListener {
    ...
    private JButton btnCompilar, btnCerrar;
    ...
    private void hazInterfaz() {
       ...
       // setShape(new RoundRectangle2D.Double(0, 0, 500, 800, 20, 20));
