    ...
    public void declararTipo() {
        ...
        switch (tipo) {
            ...
            case TipoToken.BOOLEANO:
                ...
                consumir(TipoToken.SEMI);
                break;
            case TipoToken.DOUBLE:
                consumir(TipoToken.DOUBLE);
                token = this.token;
                consumir(TipoToken.ID);
                if (tipo == TipoToken.EQ) {
                    consumir(TipoToken.EQ);
    ...
    public void status() {
        switch (tipo) {
            case TipoToken.IFX:
                ...
                while (tipo == TipoToken.WHILEX || tipo == TipoToken.IFX || tipo == TipoToken.ID || tipo == TipoToken.BOOLEANO || tipo == TipoToken.ENTERO || tipo == TipoToken.DOUBLE || tipo == TipoToken.STRING) {
            ...
            case TipoToken.WHILEX:
                ...
                while (tipo == TipoToken.WHILEX || tipo == TipoToken.IFX || tipo == TipoToken.BOOLEANO || tipo == TipoToken.ENTERO || tipo == TipoToken.PUBLICO
                        || tipo == TipoToken.PRIVADO || tipo == TipoToken.DOUBLE || tipo == TipoToken.STRING) {
                    status(); // para llamar otro statement dentro del statement
                }
                consumir(TipoToken.LLAVEDER);
                break;
            case TipoToken.ID:
                ...
                expresionAritmetica();
                consumir(TipoToken.SEMI);
                while (tipo == TipoToken.WHILEX || tipo == TipoToken.IFX || tipo == TipoToken.BOOLEANO || tipo == TipoToken.ENTERO || tipo == TipoToken.DOUBLE || tipo == TipoToken.STRING) {
                    status(); // para llamar otro statement dentro del statement
                }
                break;
            case TipoToken.BOOLEANO:
